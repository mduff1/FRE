...
void Level1Physics::load()
{
	...
	sunAttrib.vel = glm::vec3(2000.0, 2000.0, 0.0);
	...
	mercuryAttrib.vel = glm::vec3(0.0, 0.0, 0.0);
	mercuryAttrib.acc = glm::vec3(0.0, 0.0, 0.0);
	
	Planet* Mercury(new Planet("Solar System/2k_mercury.jpg", glm::dvec3(0.466 * AU, 0.0, 0.0), glm::dvec4(0.0, 0.0, 1.0, 0.0), 50.0, mercuryAttrib));
	...
	earthAttrib.mass = 0.5 * solarMass;
	...
	Earth->CalculateInitialVelocity(Sun, CalculateForceVector(Earth->GetPos() - Sun->GetPos(), Earth, Sun), glm::dvec3(0.0, 1.0, 0.0));
